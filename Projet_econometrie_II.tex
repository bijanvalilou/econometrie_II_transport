...
\FunctionTok{ggplot}\NormalTok{()}\SpecialCharTok{+}
  \FunctionTok{geom\_line}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{Transport\_France2019}\SpecialCharTok{$}\NormalTok{Year, }\AttributeTok{y=}\NormalTok{res, }\AttributeTok{color=}\StringTok{"Résidus"}\NormalTok{))}\SpecialCharTok{+}
  \FunctionTok{geom\_line}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{Transport\_France2019}\SpecialCharTok{$}\NormalTok{Year, }\AttributeTok{y=}\NormalTok{y, }\AttributeTok{color=}\StringTok{"Valeur estimée de y }\SpecialCharTok{\textbackslash{}n}\StringTok{ par le modèle"}\NormalTok{))}\SpecialCharTok{+}
  \FunctionTok{geom\_line}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{Transport\_France2019}\SpecialCharTok{$}\NormalTok{Year, }\AttributeTok{y=}\NormalTok{yf, }\AttributeTok{color=}\StringTok{"Valeur réelle de y"}\NormalTok{))}\SpecialCharTok{+}
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{x =} \StringTok{"Année"}\NormalTok{, }\AttributeTok{y =} \StringTok{"Consommation de gazole par camion (en milliers de tonnes)"}\NormalTok{, }\AttributeTok{title =} \StringTok{"Fig.8 Comparaison des résidus et }\SpecialCharTok{\textbackslash{}n}\StringTok{ des valeurs estimées par le modèle 1"}\NormalTok{) }\SpecialCharTok{+} 
    \FunctionTok{theme}\NormalTok{(}\AttributeTok{axis.text=}\FunctionTok{element\_text}\NormalTok{(}\AttributeTok{size=}\DecValTok{7}\NormalTok{),}\AttributeTok{axis.title=}\FunctionTok{element\_text}\NormalTok{(}\AttributeTok{size=}\DecValTok{11}\NormalTok{),}\AttributeTok{title =} \FunctionTok{element\_text}\NormalTok{(}\AttributeTok{size=}\DecValTok{9}\NormalTok{), }\AttributeTok{plot.title =} \FunctionTok{element\_text}\NormalTok{(}\AttributeTok{hjust =} \FloatTok{0.5}\NormalTok{, }\AttributeTok{vjust =} \FloatTok{0.5}\NormalTok{)) }\SpecialCharTok{+}
  \FunctionTok{scale\_x\_continuous}\NormalTok{(}\AttributeTok{breaks=}\FunctionTok{seq}\NormalTok{(}\DecValTok{1985}\NormalTok{,}\DecValTok{2020}\NormalTok{,}\DecValTok{5}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{Transport\_France2019\_prev }\OtherTok{\textless{}{-}} \FunctionTok{read\_excel}\NormalTok{(}\StringTok{"Transport\_France2019\_v2\_prev.xlsx"}\NormalTok{)}

\NormalTok{X2 }\OtherTok{\textless{}{-}}\NormalTok{  Transport\_France2019\_prev}\SpecialCharTok{$}\NormalTok{Pdiesel[}\DecValTok{35}\SpecialCharTok{:}\DecValTok{41}\NormalTok{]}\SpecialCharTok{/}\NormalTok{Transport\_France2019\_prev}\SpecialCharTok{$}\NormalTok{CPI[}\DecValTok{35}\SpecialCharTok{:}\DecValTok{41}\NormalTok{]}

\NormalTok{X3 }\OtherTok{\textless{}{-}}\NormalTok{  Transport\_France2019\_prev}\SpecialCharTok{$}\StringTok{"PIB en volume (en milliards d\textquotesingle{}euros 2014)"}\NormalTok{[}\DecValTok{35}\SpecialCharTok{:}\DecValTok{41}\NormalTok{]}

\NormalTok{X4 }\OtherTok{\textless{}{-}}\NormalTok{ Transport\_France2019\_prev}\SpecialCharTok{$}\NormalTok{Qtt\_Trsp\_route[}\DecValTok{35}\SpecialCharTok{:}\DecValTok{41}\NormalTok{]}

\NormalTok{Year }\OtherTok{\textless{}{-}} 
\NormalTok{h }\OtherTok{\textless{}{-}} \FunctionTok{cbind}\NormalTok{(Transport\_France2019\_prev}\SpecialCharTok{$}\NormalTok{Year[}\DecValTok{35}\SpecialCharTok{:}\DecValTok{41}\NormalTok{], X2, X3, X4)}
\FunctionTok{colnames}\NormalTok{(h) }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\StringTok{"Année"}\NormalTok{, }\StringTok{"Prix du diesel déflaté }\SpecialCharTok{\textbackslash{}n}\StringTok{ du niveau général des prix"}\NormalTok{, }\StringTok{"PIB en volume"}\NormalTok{, }\StringTok{"Quantité de biens transportés par route"}\NormalTok{)}
\FunctionTok{kable}\NormalTok{(h, }\AttributeTok{booktabs =}\NormalTok{ T, }\AttributeTok{linesep =} \StringTok{""}\NormalTok{, }\AttributeTok{caption =} \StringTok{"valeur des variables explicatives de 2019 à 2025"}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%} 
\FunctionTok{kable\_styling}\NormalTok{(}\AttributeTok{latex\_options =} \StringTok{"hold\_position"}\NormalTok{, }\AttributeTok{full\_width =}\NormalTok{ T,}\AttributeTok{font\_size =} \DecValTok{7}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%} 
...
\begin{Highlighting}[]
\FunctionTok{ggplot}\NormalTok{()}\SpecialCharTok{+}
  \FunctionTok{geom\_line}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{z[,}\DecValTok{1}\NormalTok{], }\AttributeTok{y=}\NormalTok{z[,}\DecValTok{2}\NormalTok{], }\AttributeTok{color=}\StringTok{"Valeur de la prévision"}\NormalTok{))}\SpecialCharTok{+}
  \FunctionTok{geom\_line}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{z[,}\DecValTok{1}\NormalTok{], }\AttributeTok{y=}\NormalTok{z[,}\DecValTok{3}\NormalTok{], }\AttributeTok{color=}\StringTok{"Borne inférieure"}\NormalTok{))}\SpecialCharTok{+}
  \FunctionTok{geom\_line}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{z[,}\DecValTok{1}\NormalTok{], }\AttributeTok{y=}\NormalTok{z[,}\DecValTok{4}\NormalTok{], }\AttributeTok{color=}\StringTok{"Borne supérieure"}\NormalTok{))}\SpecialCharTok{+}
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{x =} \StringTok{"Année"}\NormalTok{, }\AttributeTok{y =} \StringTok{"Consommation de gazole par camion (en milliers de tonnes)"}\NormalTok{, }\AttributeTok{title =} \StringTok{"Fig.13 Prévisions à l\textquotesingle{}horizon 2025"}\NormalTok{) }\SpecialCharTok{+} 
    \FunctionTok{theme}\NormalTok{(}\AttributeTok{axis.text=}\FunctionTok{element\_text}\NormalTok{(}\AttributeTok{size=}\DecValTok{7}\NormalTok{),}\AttributeTok{axis.title=}\FunctionTok{element\_text}\NormalTok{(}\AttributeTok{size=}\DecValTok{11}\NormalTok{),}\AttributeTok{title =} \FunctionTok{element\_text}\NormalTok{(}\AttributeTok{size=}\DecValTok{9}\NormalTok{), }\AttributeTok{plot.title =} \FunctionTok{element\_text}\NormalTok{(}\AttributeTok{hjust =} \FloatTok{0.5}\NormalTok{, }\AttributeTok{vjust =} \FloatTok{0.5}\NormalTok{)) }\SpecialCharTok{+}
  \FunctionTok{scale\_x\_continuous}\NormalTok{(}\AttributeTok{breaks=}\FunctionTok{seq}\NormalTok{(}\DecValTok{2019}\NormalTok{,}\DecValTok{2025}\NormalTok{,}\DecValTok{1}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{rmse}\OtherTok{=}\FunctionTok{sqrt}\NormalTok{(}\FunctionTok{t}\NormalTok{(Transport\_France2019\_prev}\SpecialCharTok{$}\NormalTok{Qdieselcamion[}\DecValTok{35}\NormalTok{]}\SpecialCharTok{{-}}\NormalTok{z[}\DecValTok{2}\NormalTok{,}\DecValTok{2}\NormalTok{])}\SpecialCharTok{\%*\%}\NormalTok{ (Transport\_France2019\_prev}\SpecialCharTok{$}\NormalTok{Qdieselcamion[}\DecValTok{35}\NormalTok{]}\SpecialCharTok{{-}}\NormalTok{z[}\DecValTok{2}\NormalTok{,}\DecValTok{2}\NormalTok{])}\SpecialCharTok{/}\DecValTok{2}\NormalTok{)}
\FunctionTok{cat}\NormalTok{(}\StringTok{"Valeur de l\textquotesingle{}erreur quadratique moyenne RMSE (sur les années 2018 et 2019) :"}\NormalTok{,rmse)}
\end{Highlighting}
\end{Shaded}
