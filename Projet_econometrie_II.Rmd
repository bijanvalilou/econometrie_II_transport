...
Transport_France2019 <- read_excel("Transport_France2019.xlsx")
...
vec <- c(Transport_France2019$Pdiesel/Transport_France2019$CPI,Transport_France2019$GDP,Transport_France2019$Qtt_Trsp_route)
X <- matrix( vec, ncol=3) 
